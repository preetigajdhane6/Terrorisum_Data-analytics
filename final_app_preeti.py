# -*- coding: utf-8 -*-
"""
Created on Tue Sep 22 18:42:50 2020

@author: Gajdhane preeti
"""
#Installing package
#!pip install dash
...
def load_data():
  #loading the global_terror,csv
  dataset_name = "global_terror.csv"
  
  #assigning all the requried attributes to a make a global variables
  global df
  ...
  #chart options for chart tools dropdown menu
...
def open_browser():
  # Open the default web browser with this local host
  webbrowser.open_new('http://127.0.0.1:8050/')


# The main layout of our page
def create_app_ui():
  ...
  html.H4('by Preeti Gajdhane', id='Sub_title',
          style = {
                'textAlign':'center'
                }
          ),
  dcc.Tabs(id="Tabs", value="Map",style={
                    'font-weight':'bold',
                    },children=[
  ...
  html.H6('A Big Thanks to Forsk Coding School for helping and guiding me in this project', id='End_title',
          style = {
                'textAlign':'center'
                }),
  ])
...
"""
@app.callback([Output("Chart_Dropdown", "value"),
               Output("Chart_Dropdown", "disabled"),
               Output("search", "value"),
               Output("search", "disabled")],
              [Input("subtabs2", "value")])
def update_india_ct(tab):
    chart_values = 'region_txt'
    disabled_c = False
    search = None
    disabled_s = False
    if tab == "WorldChart":
        ...
        chart_values = 'natlty1_txt'
        disabled_c = True
        search = 'India'
        disabled_s = True
    return chart_values, disabled_c, search, disabled_s"""
